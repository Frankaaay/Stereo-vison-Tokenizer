...
export OUTPUT_ROOT=/data/home/frank/experiments/stereo-input-ablation-s48-h2001-20260908-resume-v1
export RESUME_FROM_CHECKPOINT=/data/home/frank/experiments/stereo-input-ablation-s48-h2001-20260907-v1/stereo-vae/ubyy2onz/checkpoints/last.ckpt
export LATENT_CHANNELS=48
export STEREO_TRAINING_INPUT=correct
export GPU_COUNT=8
